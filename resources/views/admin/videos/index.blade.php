            ...
            <div class="bg-white rounded-lg shadow overflow-hidden hover:shadow-lg transition-shadow">
                ...
                <div class="p-4">
                    ...
                    <div class="flex justify-end gap-2 pt-2 border-t">
                        ...
                        <button
                            onclick="openDeleteModal({{ $video->video_id }}, '{{ addslashes($video->title) }}', {{ $video->questions_count ?? 0 }})"
    ...
    @push('scripts')
        <script>
            ...
            function openDeleteModal(videoId, videoTitle, questionsCount) {
                ...
                // Set the message
                let message =
                    `Are you sure you want to delete video <span class="font-bold text-red-600">"${videoTitle}"</span>?`;
